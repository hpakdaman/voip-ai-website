    ...
    <div class="container relative z-10">
        ...
        <div class="text-center max-w-4xl mx-auto mb-16 wow animate__animated animate__fadeInUp">
            <div class="inline-flex items-center px-6 py-3 rounded-full border border-white/20 mb-6"
                style="background: rgba(30, 192, 141, 0.1);">
        ...
        @php
            ...
            if ($industry === 'spa-massage') {
                $testimonials = [
                    [
                        'quote' =>
                            'Sawtic AI increased our bookings by 40%. We\'re now capturing appointments 24/7, even when we\'re with clients!',
                        'name' => 'Layla Al Zahra',
                    ...
                    [
                        'quote' =>
                            'The health screening feature is amazing. Our AI asks the right questions and ensures client safety before every treatment.',
                        'name' => 'Sarah Mitchell',
                    ...
                    [
                        'quote' =>
                            'Arabic language support helped us reach 30% more clients. Our booking rate increased dramatically!',
                ...
                $testimonials = [
                    [
                        'quote' =>
                            'Sawtic AI recovered 40% more leads for us. We closed 12 extra deals last month just from calls we would have missed!',
                        'name' => 'Ahmed Al Mansouri',
                    ...
                    [
                        'quote' =>
                            'The Arabic language support helped us reach 30% more clients. ROI was 15x in the first 3 months!',
                        'name' => 'Sarah Johnson',
                    ...
                    [
                        'quote' =>
                            '24/7 lead capture changed our business. We\'re getting qualified leads even while sleeping!',
                        'name' => 'Mona Abbasi',
        ...
        <div class="grid lg:grid-cols-3 gap-8 mb-16">
            @foreach ($testimonials as $testimonial)
                <div class="p-8 rounded-2xl border border-white/10"
                    ...
                    <div class="flex items-center">
                        <img data-src="{{ asset($testimonial['image']) }}" alt="{{ $testimonial['name'] }}"
