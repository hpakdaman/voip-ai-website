...
<section id="voice-samples" class="relative py-24" style="background-color: var(--voip-bg);">
    <div class="absolute inset-0">
        ...
        <div class="absolute inset-0"
            style="background: linear-gradient(45deg, rgba(30, 192, 141, 0.05) 0%, transparent 50%), radial-gradient(ellipse at center, rgba(29, 120, 97, 0.08) 0%, transparent 70%);">
        </div>
        <!-- Sound Wave Pattern -->
        <div class="absolute inset-0 opacity-5"
            style="background-image: repeating-linear-gradient(90deg, rgba(30, 192, 141, 0.3) 0px, rgba(30, 192, 141, 0.3) 2px, transparent 2px, transparent 20px);">
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-16">
            @foreach ($demos as $index => $demo)
                <div class="wow animate__animated animate__fadeInUp" data-wow-delay="{{ $index * 0.2 + 0.2 }}s">
                    <!-- Demo Card -->
                    <div class="p-8 rounded-2xl border border-white/10 transition-all duration-300 hover:scale-105"
                        ...
                        <p class="text-slate-300 text-sm leading-relaxed mb-6">
                            {{ $demo['description'] ?? 'Demo description' }}</p>

                        <!-- Audio Player -->
                        <div class="voice-demo-player mb-6">
                            <audio controls class="w-full" data-demo-type="{{ $demo['scenario'] ?? 'general' }}">
                                <source src="{{ asset($demo['file_path'] ?? 'assets/audio/solutions/demo.mp3') }}"
                                    type="audio/mpeg">
        ...
        <div class="text-center wow animate__animated animate__fadeInUp" data-wow-delay="0.8s">
            <div class="max-w-3xl mx-auto p-8 rounded-2xl border border-white/10"
                ...
                @php
                    ...
                    $customDemoDesc =
                        'We\'ll create a personalized voice demo using your actual property listings and scenarios';
                    if (str_contains(request()->path(), 'spa-massage')) {
                        $customDemoTitle = 'Want a Custom Demo for Your Spa Services?';
                        $customDemoDesc =
                            'We\'ll create a personalized voice demo using your actual spa treatments and booking scenarios';
                    }
                @endphp
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="/contact-us"
                        ...
                        data-cta-track="voice-samples-custom-demo">
                    ...
                    <a href="tel:+97148647245"
                        ...
                        data-cta-track="voice-samples-call">
