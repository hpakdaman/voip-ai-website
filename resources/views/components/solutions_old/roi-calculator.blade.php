...
<section id="roi-calculator" class="relative py-24" style="background-color: var(--voip-dark-bg);">
    <div class="absolute inset-0">
        ...
        <div class="absolute inset-0"
            style="background: linear-gradient(135deg, rgba(30, 192, 141, 0.1) 0%, transparent 70%), radial-gradient(ellipse at left, rgba(29, 120, 97, 0.05) 0%, transparent 50%);">
        </div>
        <!-- Grid Pattern -->
        <div class="absolute inset-0 opacity-5"
            style="background-image: linear-gradient(rgba(30, 192, 141, 0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(30, 192, 141, 0.1) 1px, transparent 1px); background-size: 50px 50px;">
        </div>
    </div>
    ...
    <div class="container relative z-10">
        ...
        <div class="text-center max-w-4xl mx-auto mb-16 wow animate__animated animate__fadeInUp" data-wow-delay="0.1s">
            <div class="inline-flex items-center px-6 py-3 rounded-full border border-white/20 mb-6"
                style="background: rgba(30, 192, 141, 0.1); backdrop-filter: blur(10px);">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div class="wow animate__animated animate__fadeInLeft" data-wow-delay="0.2s">
                <div class="p-8 rounded-2xl border border-white/10 h-full flex flex-col"
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="range" id="monthly-calls" min="50" max="1000" value="200"
                                class="w-full roi-slider" style="accent-color: var(--voip-link);">
                        ...
                        <div>
                            ...
                            <input type="range" id="avg-commission" min="{{ $minValue }}"
                                max="{{ $maxValue }}" value="{{ $defaultValue }}"
                                step="{{ str_contains(request()->path(), 'spa-massage') ? '50' : '5000' }}"
                                class="w-full roi-slider" style="accent-color: var(--voip-link);">
                            <div class="flex justify-between text-sm text-slate-400 mt-1">
                                <span>{{ $minLabel }}</span>
                        ...
                        <div>
                            ...
                            <input type="range" id="miss-rate" min="10" max="80" value="35"
                                class="w-full roi-slider" style="accent-color: var(--voip-link);">
                            <div class="flex justify-between text-sm text-slate-400 mt-1">
                                <span>10%</span>
                        ...
                        <div>
                            ...
                            <input type="range" id="conversion-rate" min="1" max="30"
                                value="{{ $conversionDefault }}" class="w-full roi-slider"
                                style="accent-color: var(--voip-link);">
                            <div class="flex justify-between text-sm text-slate-400 mt-1">
                                <span>1%</span>
                                <span id="conversion-value"
                                    class="font-semibold text-white">{{ $conversionDefault }}%</span>
                                <span>30%</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="wow animate__animated animate__fadeInRight" data-wow-delay="0.4s">
                <div class="p-8 rounded-2xl border border-white/10 h-full flex flex-col"
                    style="background: linear-gradient(135deg, rgba(30, 192, 141, 0.15) 0%, rgba(22, 47, 58, 0.4) 100%);">
                    ...
                    <div class="space-y-4 mb-6 flex-1">
                        ...
                        <div class="p-4 rounded-xl border-2 border-green-400/30"
                            ...
                            @endphp
                            <div class="text-3xl font-bold text-white" id="revenue-increase">{{ $defaultRevenue }}
                            </div>
                        </div>

                        <div class="p-3 rounded-xl border border-white/10"
                            style="background: rgba(30, 192, 141, 0.05);">
                    ...
                    <!-- CTA Button -->
                    <a href="/contact-us"
                        class="w-full inline-flex items-center justify-center px-6 py-3 rounded-xl font-semibold text-white transition-all duration-300 hover:scale-105 mt-auto"
                        style="background: linear-gradient(135deg, var(--voip-primary) 0%, var(--voip-link) 100%); box-shadow: 0 10px 30px rgba(30, 192, 141, 0.3);"
                        data-cta-track="roi-calculator-get-started">
