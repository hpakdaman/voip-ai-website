    ...
    <div class="container relative z-10">
        ...
        <div class="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="wow animate__animated animate__fadeInUp" data-wow-delay="{{ ($index * 0.2) + 0.1 }}s">
                <div class="h-full p-6 rounded-2xl border border-red-400/30 transition-all duration-300 hover:border-red-400/50 hover:scale-105 flex flex-col" style="background: linear-gradient(135deg, rgba(239, 68, 68, 0.1) 0%, rgba(22, 47, 58, 0.3) 100%);">
                    <!-- Problem Icon -->
